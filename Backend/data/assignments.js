const assignments = [
    ...
    { title: 'Quantum Physics Problem Set', subject: 'Physics', deadline: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000), status: 'Pending Payment', writerName: 'John Smith', progress: 100, completedFiles: [{name: 'problems.pdf', path: 'uploads/sample-problems.pdf'}], price: 90 },
