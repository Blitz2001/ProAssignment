...
const WriterStatusBadge: React.FC<{ status: Writer['status'] }> = ({ status }) => {
    const statusClasses = {
...
const AssignmentStatusBadge: React.FC<{ status: AssignmentStatus }> = ({ status }) => {
    const statusClasses = {
...
interface WriterProfileData extends Writer {
    email: string;
}

const WriterProfilePage: React.FC<WriterProfilePageProps> = ({ writerId }) => {
    const [writer, setWriter] = useState<WriterProfileData | null>(null);
